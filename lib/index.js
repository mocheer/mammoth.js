        ...
        .then(function (docxFile) {
            return docxReader.read(docxFile, input)
                ...
                .then(function (documentResult) {
                    ...
                    return convertDocumentToHtml(documentResult, options, docxFile);
                });
        });
}
...
function convertDocumentToHtml(documentResult, options, docxFile) {
    ...
    return documentResult.flatMapThen(function (document) {
        return styleMapResult.flatMapThen(function (styleMap) {
            return documentConverter.convertToHtml(document, docxFile);
        });
    });
}
