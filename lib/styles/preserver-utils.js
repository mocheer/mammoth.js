...
// 新增获取当前表格样式的方法
exports.getCurTableStyles = getCurTableStyles;
exports.getCurTableRowStyles = getCurTableRowStyles;
...
var curTableStyles;//当前表格的全局样式，用于继承
var curTableRowStyles;

function getCurTableStyles() {
  return curTableStyles;
}

function getCurTableRowStyles() {
  return curTableRowStyles;
}
/**
...
function _convertPreservableStylesToCssString(elementStyles, reduceBorderStyles, type) {
  switch (type) {
    case 'table':
      curTableStyles = elementStyles;
    case 'row':
      curTableRowStyles = elementStyles = T.assign({}, elementStyles);
